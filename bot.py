# Kopiere diesen kompletten Code in die bot.py Datei auf GitHub
...
# Lädt die Umgebungsvariablen (auf Railway kommen sie direkt von der Plattform)
load_dotenv()
...
async def sende_tagesuebersicht():
    ...
    embed = discord.Embed(
        ...
        description="Die wichtigsten Ereignisse des Tages.",
            ...
            try:
                ...
                if timedelta(minutes=14) < zeit_bis_event <= timedelta(minutes=15):
                    ...
                    if alarm_id not in gesendete_alarme:
                        embed = discord.Embed(
                            title="🚨 ALARM: WICHTIGES EREIGNIS IN 15 MINUTEN 🚨",
